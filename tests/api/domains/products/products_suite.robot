...
UC-PROD-001-B1 Lista Boundary Limit Zero
    ...
    Entao A Resposta Devera Conter Status 200 E Parametros Ecoados    limit_zero    skip_zero
...
UC-PROD-001-B2 Lista Boundary Limit Um
    ...
    [Tags]    limite
    Dado Que Tenho Parametros Boundary De Paginacao
    Quando Solicito Lista De Produtos Com Limit E Skip    limit_um    skip_zero
    Entao A Resposta Devera Conter Status 200 E Parametros Ecoados    limit_um    skip_zero
...
UC-PROD-001-B3 Lista Boundary Limit Grande
    ...
    [Tags]    limite
    Dado Que Tenho Parametros Boundary De Paginacao
    Quando Solicito Lista De Produtos Com Limit E Skip    limit_grande    skip_zero
    Entao A Resposta Devera Conter Status 200 E Parametros Ecoados    limit_grande    skip_zero
...
UC-PROD-001-B4 Lista Boundary Skip Alto
    ...
    [Tags]    limite
    Dado Que Tenho Parametros Boundary De Paginacao
    Quando Solicito Lista De Produtos Com Limit E Skip    limit_um    skip_alto
    Entao A Resposta Devera Conter Status 200 E Parametros Ecoados    limit_um    skip_alto
